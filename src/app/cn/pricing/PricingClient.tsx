...
import { CnPayButtons } from "@/components/CnPayButtons";

function CnPricingInner() {
  const { t, href } = useLocale();
  const price = process.env.NEXT_PUBLIC_CN_PRICE_CNY || "9.9";
...
export function CnPricingClient() {
  return (
